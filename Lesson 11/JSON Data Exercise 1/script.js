async function fetchData() {
    try {
        ...
        data.forEach(country => {
            ...
            //Add the country details as text content to the list item
            capital.textContent = ``; //MODIFY THIS LINE
            details.appendChild(capital);

            let currency = document.createElement('li');
            //Add the country details as text content to the list item
            currency.textContent = ``; //MODIFY THIS LINE
            details.appendChild(currency);
            
            let flag = document.createElement('li');
            //Add the flag as an image
            let img = document.createElement('img');
            img.src = NaN; //MODIFY THIS LINE
